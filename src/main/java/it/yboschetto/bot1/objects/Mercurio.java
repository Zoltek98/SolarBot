...
public class Mercurio {
        private double N, i, w, a, e, M, L, E0, E1, x, y, r, v, ecl, lon, x2, y2, z, d, sup, ar, dec, AO, xorr, yorr, zorr, xorr2,xgmer,ygmer,zgmer;
 ...
 public Mercurio(double d,double ecl,Date ora)
        {
            adesso = ora;
            this.ecl = ecl;
  ...
  public void Posizione(double latitudine, double longitudine)
        {
            ...
            lonmer = Math.atan2(yeclip, xeclip) * 180 / pi;
            latmer = Math.atan2(zeclip, Math.sqrt(xeclip * xeclip + yeclip * yeclip)) * 180 / pi;
            latmer = Sole.rev(latmer);
            xgmer = sole.getXequat()+ xeclip;
            ygmer = sole.getYequat() + yeclip;
            zgmer = sole.getZequat() + zeclip;
            ar = Sole.rev(Math.atan2(ygmer, xgmer) * 180 / pi);
            dec = Math.atan2(zgmer, Math.sqrt(xgmer * xgmer + ygmer * ygmer)) * 180 / pi;
